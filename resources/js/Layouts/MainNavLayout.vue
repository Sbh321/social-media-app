...
<template>
    ...
    >
        <div class="flex items-center justify-start w-[260px]" id="NavLeft">
            ...
            >
                <Magnify class="w-6 h-6 text-gray-500" />
                <input
        ...
        >
            ...
            <button
                class="flex items-center justify-center h-[48px] p-1 hover:bg-[#F2F2F2F] w-full rounded-lg mx-1 cursor-pointer"
            >
                <TelevisionPlay
                    class="mx-auto"
                    :size="27"
            ...
            <div class="flex items-center justify-center relative">
                ...
                >
                    <Link href="/" @click="showMenu = !showMenu">
                        <div
                            class="flex items-center gap-3 hover:bg-gray-200 rounded-lg"
                        >
                            <img
                                class="rounded-full ml-1 min-w-[35px] max-h-[35px] cursor-pointer"
                                src="https://picsum.photos/id/87/300/320"
                            />
                            <span>Subham Bhandari</span>
                        </div>
                    </Link>
                    <Link
                        class="w-full"
                    ...
                    >
                        <div
                            class="flex items-center gap-3 hover:br-gray-200 px-2 py-2.5 rounded-lg"
                        >
